...
Select Other Forms of Area Management/Designation>Click on the download icon on [Exlusive Economic Zone](https://www.emodnet-humanactivities.eu/search-results.php?dataname=Exclusive+Economic+Zone).
...
```{r}
ggplot()+ 
  geom_sf(data = German_EEZ,colour = "red", fill= NA,alpha=0.9, lwd = 1)+
  geom_sf(data = German_coast,colour = "red", fill= '#bde0fe',alpha=0.9, lwd = 1,linetype="dashed")+
  geom_sf(data = German_land, colour = 'black', fill = '#ffffbe')+
